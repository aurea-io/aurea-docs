...
| :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| [`26-09-02_19-27_internal-platform-production`](./26-09-02_19-27_internal-platform-production/README.md) | `main @ 9959c18` | `main @ 381494d` | `e1a442f` | `240320a` | 🟡 PARCIAL | Deploy Render live, login platform_owner en Chrome, tenants, planes y features con datos sintéticos; aprobación del backend cliente y rotación del usuario de evidencia pendientes. |
